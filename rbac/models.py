...
class Menu(models.Model):
    ...
    菜单
    """
    name = models.CharField(max_length=30, unique=True, verbose_name="菜单名稱")
    icon = models.CharField(max_length=50, null=True, blank=True, verbose_name="菜單图标")
    ...
    component = models.CharField(max_length=200, null=True, blank=True, verbose_name="组件路徑")
...
class UserProfile(AbstractUser):
    ...
    personal_no = models.CharField(max_length=20, default="", verbose_name="工號")
